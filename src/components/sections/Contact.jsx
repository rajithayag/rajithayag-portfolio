...
export const Contact = () => {
    ...
    return (
        <section id="contact" className="min-h-screen flex items-center justify-center py-20">
            <RevealOnScroll>
                <div className="px-4 w-100 mx-auto">
                ...
                <a href="https://www.linkedin.com/in/rajithayag/" target="_blank" rel="nofollow">
                    <img className="w-20 h-auto block mx-auto relative transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0" src="https://rajithayag.github.io/rajithayag-portfolio/images/linkdin.png" alt="LinkedIn-Profile" title="LinkedIn - Rajitha Gunasekara" />
                    </a>
                </div>
