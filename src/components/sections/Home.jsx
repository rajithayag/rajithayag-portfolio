        ...
        <RevealOnScroll>
            <div className="text-center z-10 px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 justify-center relative">
                    ...
                    <img className="p-4 w-40 h-auto block mx-auto" src="/images/fundamentals-of-agile-project-management.png" alt="agile-project-management" title="Agile Project Management" />
                    </a>

                    <a href="https://www.credly.com/badges/5f81e7a5-39ef-43fe-b4bd-00bb129d0cfb/public_url" target="_blank" rel="nofollow">
                    <img className="p-4 w-40 h-auto block mx-auto" src="/images/corporate-digital-communications.png" alt="corporate-digital-communications" title="Corporate Digital Communications" />
                    </a>

                    <a href="https://www.credly.com/badges/a3dd4983-6252-4c1c-b992-decd328677f9/public_url" target="_blank" rel="nofollow">
                    <img className="p-4 w-40 h-auto block mx-auto" src="/images/fundamentals-of-predictive-project-management.png" alt="predictive-project-management" title="Predictive Project Management" />
                    </a>
